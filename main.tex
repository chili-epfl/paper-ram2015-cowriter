...
Further qualitative assessment of engagement over longer interactions were
...
\begin{figure}
    ...
    \caption{\small Text generated by the robot, before and after training with
        the child (in French). As an example, the red box emphasizes the changes on the word
    ``envoyer''.}
    \label{fig:stimuli}
\end{figure}
...
Thomas is a six years old child. It is under the care of an occupational
therapist. According to the therapist, he shows visuo-constructive deficits.
As an effect in writing activities, he was frequently performing random attempts and then was comparing
with the provided template. What is more, Thomas is strongly careless : he rarely payed attention to
...
allographs, he started to take care on the allographs he was providing to it. He used the
...
visible~\ref{learning_6_demos},~\ref{henry_distances}.
Therefor, Thomas quickly entered in an self-rewarding game where the rewards were
the improvements of the robot, that enhanced his attention. 
