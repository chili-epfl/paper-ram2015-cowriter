...
\begin{table}
    ...
    \begin{tabular}{ccccll}
        \toprule
        Child          & \#demos & \#positive & \#negative & $r_{robot}$ & \\ \midrule
        \emph{Valérie} & 127 & 24 & 6 & 0.25 \small\tt **  \\ 
        \emph{Émilien} & 223 & 20 & 9 & 0.06 \small\it ns  \\
        \emph{Mathieu} & 131 & 10 & 3 & 0.23 \small\tt **  \\
        \emph{Nicolas} & 115 & 16 & 4 & 0.31 \small\tt *** \\
        \emph{Johan}   & 98 & 10 & 5  & 0.10 \small\it ns  \\
        \emph{Antoine} & 83 & 10 & 3  & 0.20 \small\tt *   \\
        \emph{Adèle}   & 35 & 4 & 2   & 0.28 \small\tt *   \\
        \emph{Marie}   & 40 & 5 & 1   & -0.02 \small\it ns \\ \midrule
        Total          & 852 & 99 & 33  &   & \\ \bottomrule
    \end{tabular}
    \caption{\small Feedback from the children to the robot. \emph{\#demos}
        denotes the total number of demonstrations drawn by the children;
        \emph{\#positive} and \emph{\#negative} the number of positive \resp
        negative feedbacks they provided. $r_{robot}$ reflects the correlation
...
To study the correlation between the children's feedback and the robot's
actual improvements, we estimate the robot's progress as the difference between an
...
to the positive or negative feedback provided by the children, following a
statistical method presented in~\cite{jacq2016building}.

We find (Table~\ref{table:scores}) that the feedback of five out of the eight
children do significantly correlate with the actual performance of the robot:
this indicates that these children are effectively taking on the teacher's
clothes and are seriously providing feedback to the robot. \fixme{what can we
say about the 3 others? they did not play seriously, or they were unable to
actually recognize the robot mistakes?}
