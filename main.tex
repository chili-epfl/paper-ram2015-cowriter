...
different schools (resulting in relatively short child-robot interactions with
...
and for two case studies that each lasted several weeks. Table~\ref{studies}
...
{\it Thomas}     & Case-study, spanning over 4 weeks              & 1h $\times$ 4 weeks        & 1                                     & 5          \\
{\it Normandie}     & Individual interactions at surgery               & 1h $\times$ 3 sessions & 8                                     & 6-8          \\ \bottomrule
\end{tabular}
\end{table}
...
handwriting acquisition: Valentine (7 years old), Alexandre (6.5) and Jonathan
(7) are under the care of the occupational therapist. Enzo (8) and Matenzo (7)
are repeating their school year because of writing difficulties. Mona (6) and
Adele (8) are both ranked at the bottom of their respective classes in writing
activities. Nathan (7) is under the care of a neurologist, and has been
