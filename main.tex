...
accepted by the children and practitioners, and what are the outcomes that can
be expected.
...
at several levels. We show that:
...
social factors. Self-confidence is one of them. Our approach that endows the
child with the role of a teacher who can help a robot: we expect it may help
some children to recover self-esteem and self-confidence. However the
