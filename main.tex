...
Diego is a six years old child with troubles in handwriting and a poor
self-esteem. Our goal was to figure out an environment in
order to make Diego sustaining engagement over four sessions of one hour, one
...
handwriting, Clem had strong difficulties and needed the help of Diego.\\

During the first session, Diego just teached single letters to the robot.
...
laboratory. In front of Diego, Mimi said to Clem that it did not believe 
it realy improved its handwritting, and that the responses it recieved
was written by Diego. To prove that it actualy improved its writing,
...
In all sessions, Diego was focused on the activity during forty minutes up to
one hour. In total, he provided 154 letters as demonstration.\\

Diego accepted our scenario and seriously played the game. At the
...
As a technical result, we do not know if Diego improved his handwriting but he
likely conviced himself he was good enough at writing to help someone else (the
robot in that case). To show to Diego how much he improved the robot's
...
sessions as well. This time, we assumed that a scenario like the one we used for Diego was
